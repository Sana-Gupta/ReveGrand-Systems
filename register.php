                    ...
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        <div class="form-row">
                         ...
                         <div class="form-row my-4">
                            <div class="col">
                                <input type="text" value="<?php if(isset($_POST['gender'])) echo $_POST['gender'];  ?>" required name="gender" id="gender" class="form-control" placeholder="Gender*">
                            </div>
                        </div>
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="text" value="<?php if(isset($_POST['address'])) echo $_POST['address'];  ?>" required name="address" id="address" class="form-control" placeholder="Address*">
                            </div>
                        </div>
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="tel" value="<?php if(isset($_POST['number'])) echo $_POST['number'];  ?>" required name="number" id="number" class="form-control" placeholder="Contact*">
                            </div>
                        </div>
